...
Stage의 고정된 4가지 상태 대신 alias를 사용하여 champion/challenger/shadow/rollback 같은 운영 의도를 자유롭게 표현하고, FastAPI 메모리 내 모델 교체(hot swap)로 Pod 재시작 없이 zero-downtime 모델 전환을 구현한다.
