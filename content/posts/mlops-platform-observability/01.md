...
> 
> 새 클러스터에도 동일한 Observability 스택을 재현할 수 있는 뼈대를 먼저 만들었습니다.”
> 
...
> 
> 
> A4에서 **local-path 기반 TSDB 최적화**로 바꿔가는 스토리로 이어갑니다.
> 
...
> 
> 
> A4에서 공식문서에서 권장하는  “Prometheus만 local-path로 옮기는 과정”을
> 
...
- **스토리텔링을 위해 “처음엔 NFS → 나중에 local-path”도 괜찮습니다**
    ...
    블로그 입장에서는, 지금처럼 NFS 기반으로 먼저 안정적인 구조를 만들고,
    
    A4에서 “왜 Prometheus는 local-path가 나은지”를 근거와 함께 보여주는 게
    
    읽는 사람 입장에서 훨씬 교육적인 흐름이 됩니다.
