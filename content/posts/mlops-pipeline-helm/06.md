...
> “모델 배포 시 실무에서는 새 모델이 학습된 뒤,
> 
> 기존 모델과 교체되는 과정을 자동화할 필요가 있습니다.
> 
> Airflow에서 학습 DAG 실행 → MLflow 등록 → FastAPI가 새 모델 로딩 구조는,
> 
> 초기 핫스왑 형태를 실험한 예제입니다.”
> 
- DAG로 train_model_v1/v2 학습 → MLflow에 등록
- FastAPI 재시작으로 모델 핫스왑 → 수동 초기 구조지만 **배포 자동화 실험**의 기반
- 추후엔 A/B Test, Canary, Zero-Downtime 구성으로 확장 가능
