...
Feast 도입 전에 스키마·버전화·재현성 계약을 먼저 확립해야 도구 위에 얹기만 하면 되고, 스키마는 ConfigMap으로 분리하여 ArgoCD sync 기반 GitOps 배포와 롤백을 가능하게 했습니다. 버전 디렉토리를 1단 구조로 고정하여 최신 버전 탐색과 latest 포인터 도입을 단순화했습니다.
