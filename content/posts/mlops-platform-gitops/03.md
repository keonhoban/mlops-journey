...
## Slack Alert 통합: FastAPI·Airflow 공용 구조 + 템플릿 확장 기반

---

## 🧠 시나리오 설명

> “운영 환경에서 가장 무서운 건 **문제가 생겼는데 아무도 모르고 있는 상황**입니다.”
> 
> 
> “그래서 2단계에서는 FastAPI와 Airflow가 각자 흩어져 보내던 알림을
> 
> **하나의 Slack 인터페이스로 완전히 통합**했습니다.”
> 
...
flowchart LR
  ...
  subgraph Alerts["🔔 Alerts Interface"]
    SSA["send_slack_alert(text)"]
    FAIL["alert_slack(context)"]
  end
  ...
  class Apps,Alerts sub;
  class FA,AF,SSA,FAIL,Slack node;
...
> 모든 DAG에 on_failure_callback=alert_slack 적용
> 
> 
> → 실패 시 로그 링크 포함 메시지 자동 전송
> 
...
> 이제 FastAPI와 Airflow가 하나의 Slack 인터페이스로 통합되었습니다.
> 
> 
> 단일 함수(`send_slack_alert`)만으로 학습·등록·핫스왑 전 구간의 관제 알림을 연결할 수 있으며,
> 
> 환경 분리를 유지하면서도 실시간 운영 모니터링이 가능해졌습니다.
>
