...
MLflow Alias 기반 라우팅으로 모델 버전 변경 시 서빙 코드 수정을 제거하고, 단일 FastAPI 앱에서 환경변수로 A/B·Canary·Blue-Green 전략을 배포 없이 전환할 수 있게 했습니다. 3단계 헬스체크(ok/degraded/unhealthy)로 부분 장애 시에도 서비스를 유지합니다.
