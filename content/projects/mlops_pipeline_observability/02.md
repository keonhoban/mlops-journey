+++
date = '2025-11-21T17:10:21+09:00'
draft = false
...
| 구분 | 증명 핵심 |
| --- | --- |
| **A. Observability 계층** | ArgoCD 상태 · Prometheus/Loki 정상 수집 · Slack 알람 도착 |
| **B. FastAPI Observability 
& Grafana 대시보드** | FastAPI 대시보드 동작 · 에러/지연 알람 작동 |
| **C. Data Pipeline (Airflow + S3)** | Airflow DAG 성공 · S3 Raw→Feature 변환 확인 |
